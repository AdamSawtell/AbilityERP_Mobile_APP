# SAW025 — Organisation Audit category KPIs & layout
...
| **Depends on** | SAW023 (NDIS Audit Tool); Findings UX is SAW024 |
...
One function: **category KPIs and layout** on Organisation Audit — population, readiness, findings counts, category-specific calculations, progressive field groups, and plain-language calculation explanations.

Findings tab strip / Open & Fix navigation is **SAW024** (including SQL 40).
