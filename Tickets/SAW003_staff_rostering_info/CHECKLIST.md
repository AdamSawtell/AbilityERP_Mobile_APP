...
- [x] Staging + HCO on JAR `1.1.0.2026071511`
- [x] HCO E2E unmatched + AND filter (2026-07-13+)
- [x] `DEPLOY.md` + GitHub [#3] for agent handoff (`1511` / Not Rostered tick + leave Unavailable)
- [x] `EXTERNAL-SUMMARY.md` ready for customer ticket
- [ ] Refresh Downloads packs to JAR `1511` + SQL through `24` when next shipping a client zip
- [x] No app dependency
