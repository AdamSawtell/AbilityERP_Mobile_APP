...
- [x] Staging + HCO on JAR `1.1.0.2026071510`
- [x] HCO E2E unmatched + AND filter (2026-07-13+)
- [x] `DEPLOY.md` + GitHub [#3] for agent handoff (`1510` / JAR-only + SQL through 24 / scoped North expand)
- [x] `EXTERNAL-SUMMARY.md` ready for customer ticket
- [ ] Refresh Downloads packs to JAR `1510` + SQL through `24` when next shipping a client zip
- [x] No app dependency
