...
**Status:** Ready for client install (JAR **1.1.0.2026072214** + SQL through **26** on staging and HCO Test)  
...
| **OSGi plugin** | `com.aberp.rostering.staffinfo` `1.1.0.2026072214` | Java Info + callout (restart required) |
| **Process** | *(none new)* | — |
| **Menu** | *(none new)* | — |
...
- JAR must be **`1.1.0.2026072214`** and **≥ ~40 KB** (known-good ~52 KB). A ~29 KB file with an older version string is a **stale build** (banner only — missing ticks / credential list).
...
- Prebuilt JAR: `idempiere-plugins/com.aberp.rostering.staffinfo/release/com.aberp.rostering.staffinfo_1.1.0.2026072214.jar`
