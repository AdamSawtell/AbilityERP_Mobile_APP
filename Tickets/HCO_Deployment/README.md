...
| **Host (HCO20260714 dry run / Test001)** | `3.27.122.147` (hostname `ip-172-31-3-32`; prior IP `54.253.165.194`) — key `Documents\SSH Keys\HCO_Prod_KP.pem` — theme ticket [`SAW033`](../SAW033_hco_theme_plugin/); release ticket [`SAW020`](../SAW020_hco20260714_release/) |
...
| **WebUI** | Prod `https://abilityerp.hco.net.au/webui/` · dry run / Test001 `http://3.27.122.147/webui/` · prior Test `http://13.210.248.141/webui/` |
...
| [SAW032](../SAW032_sms_staff_info_multiselect/DEPLOY.md) | SMS Staff Rostering Info multi-select — prod push pending (SQL 28 + JAR 2218) |
| [SAW033](../SAW033_hco_theme_plugin/NOTES.md#hco-future-deployments-variables) | HCO theme plugin — staging host `3.27.122.147` (`ip-172-31-3-32`); prod promote later |
