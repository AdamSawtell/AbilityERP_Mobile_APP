package com.aberp.unavailability.planning.factory;
...
import com.aberp.unavailability.planning.info.UnavailabilityPlanningInfoWindow;

/**
 * Returns {@link UnavailabilityPlanningInfoWindow} for Unavailability Planning Info UU.
 * Higher service.ranking so InfoManager prefers this over DefaultInfoFactory.
 */
public class UnavailabilityPlanningInfoFactory implements IInfoFactory {
	...
	public InfoPanel create(int windowNo, String tableName, String keyColumn, String value,
		...
		if (!UnavailabilityPlanningInfoWindow.matchesInfoWindow(AD_InfoWindow_ID)) {
			return null;
		}
		return new UnavailabilityPlanningInfoWindow(windowNo, tableName, keyColumn, value, multiSelection, whereClause,
	...
	public InfoPanel create(Lookup lookup, GridField field, String tableName, String keyColumn,
		...
		return new UnavailabilityPlanningInfoWindow(windowNo, tableName, keyColumn, queryValue, multiSelection, whereClause,
	...
	public InfoWindow create(int AD_InfoWindow_ID) {
		...
		return new UnavailabilityPlanningInfoWindow(0, tableName, keyColumn, "", false, "", AD_InfoWindow_ID, false);
	}
}
