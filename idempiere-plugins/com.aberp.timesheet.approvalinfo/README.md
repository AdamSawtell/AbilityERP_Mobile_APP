...
**Agent install on another build:**  
[`Tickets/SAW010_timesheet_approval_info_columns/DEPLOY.md`](../../Tickets/SAW010_timesheet_approval_info_columns/DEPLOY.md)  
...
Then **Cache Reset** (or log out/in). **No** iDempiere restart for this SQL pack.

Optional staging seed rows (**AbilityERP seed only — never on foreign clients**):
...
Approve execute needs `com.aberp.timesheetapproval.processes.setstatus` JAR on the host — not shipped in this pack.
