...
for f in 00-preflight-uuids.sql 01-add-paid-criteria.sql 04-add-info-menu.sql 05-grant-admin-infowindow-access.sql 02-verify.sql 03-functional-check.sql; do
  echo "=== $f ==="
