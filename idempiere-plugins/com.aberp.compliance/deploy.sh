...
echo "Applying Phase-2/3 AD SQL (view + process button + employee rules)"
...
echo "Deploy complete — Cache Reset / logout-in, then NDIS Audit Tool → Refresh Compliance"
