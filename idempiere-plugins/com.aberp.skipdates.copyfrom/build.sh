#!/bin/bash
# Build com.aberp.skipdates.copyfrom OSGi bundle on the iDempiere server.
set -euo pipefail
...
JAR_NAME="com.aberp.skipdates.copyfrom_${VERSION}.jar"
...
cp "$PLUGIN_DIR/skipdates-copyfrom-process.xml" "$CLASSES_DIR/"
