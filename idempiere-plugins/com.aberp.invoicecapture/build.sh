#!/bin/bash
# Build com.aberp.invoicecapture OSGi bundle on the iDempiere server.
set -euo pipefail
...
VERSION="7.1.0.202607142000"
JAR_NAME="com.aberp.invoicecapture_${VERSION}.jar"
...
cp "$PLUGIN_DIR/invoicecapture-process.xml" "$CLASSES_DIR/"
