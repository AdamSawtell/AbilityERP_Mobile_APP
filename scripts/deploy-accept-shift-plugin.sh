#!/bin/bash
# Remote deploy helper: sync plugin to EC2 and run build+deploy on idempiere server.
set -euo pipefail
...
REMOTE_DIR="/opt/ability-erp-pwa/idempiere-plugins/com.aberp.rosteredshift.process"
