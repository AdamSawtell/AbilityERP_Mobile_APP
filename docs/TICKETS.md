...
| SAW011 | `accept_shift_request` | idempiere | Accept Shift Request: Response Log REQ â†’ Employee tab assign | done | [#11](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/11) | [`Tickets/SAW011_â€¦`](../Tickets/SAW011_accept_shift_request/) |
...
| SAW024 | `employee_open_findings` | idempiere | NDIS Audit Tool Employee â†’ Open Findings (why / resolve / Zoom) | in-progress | [#24](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/24) | [`Tickets/SAW024_â€¦`](../Tickets/SAW024_employee_open_findings/) |
| SAW025 | `category_tab_summaries` | idempiere | Organisation Audit category tabs: population + 90d change + expanded KPIs | in-progress | [#25](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/25) | [`Tickets/SAW025_â€¦`](../Tickets/SAW025_category_tab_summaries/) |
...
| SAW027 | `activity_audit` | idempiere | Activity Audit â€” configurable nightly keyword review of Contact Activities | in-progress | [#27](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/27) | [`Tickets/SAW027_â€¦`](../Tickets/SAW027_activity_audit/) |
| SAW028 | `activity_viewer_links` | idempiere | Activity Viewer â€” Client / Employee / Support Location link buttons | done | [#28](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/28) | [`Tickets/SAW028_â€¦`](../Tickets/SAW028_activity_viewer_links/) |
| SAW029 | `activity_audit_review_ux` | idempiere | Activity Audit Review — field groups; Active in Audit; hide Follow-Up checkbox | done | [#29](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/29) | [`Tickets/SAW029_…`](../Tickets/SAW029_activity_audit_review_ux/) |
| SAW030 | `response_log_find_fill` | idempiere | Response Log Find and Fill: open staff Info prefilled; OK fills vacant Employee | in-progress | [#30](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/30) | [`Tickets/SAW030_…`](../Tickets/SAW030_response_log_find_fill/) |
