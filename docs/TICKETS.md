...
| SAW027 | `activity_audit` | idempiere | Activity Audit — terms, nightly/historical, review UX, Activity Viewer links (one product) | in-progress | [#27](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/27) | [`Tickets/SAW027_…`](../Tickets/SAW027_activity_audit/) |
