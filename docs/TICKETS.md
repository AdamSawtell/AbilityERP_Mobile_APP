...
| SAW034 | `pwa_install_shell` | app | Installable PWA shell: icons verified, service worker, install hint | in-progress | [#34](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/34) | _(app — no folder)_ |
