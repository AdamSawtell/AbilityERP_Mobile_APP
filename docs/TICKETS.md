...
| SAW037 | `fewer_taps` | app | Fewer taps: home=Schedule, shift?care plan, quick Note | in-progress | [#37](https://github.com/AdamSawtell/AbilityERP_Mobile_APP/issues/37) | _(app ? no folder)_ |
